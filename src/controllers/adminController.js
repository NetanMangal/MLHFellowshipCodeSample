...
// const joiValidations = require("../validations/adminJoiValidations.js");
...
async function login(req, res, next) {
    ...
    try {
        ...
        // const errors = validationHandler(joiValidations.validateLoginSchema(admin));
        // if (errors) return res.status(400).send({ success: false, msg: errors });
        // 
        ...
        let adminExist = await adminModel.findOne({ "email": recEmail });
